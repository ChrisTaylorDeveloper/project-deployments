 ...
 * @var iterable<\App\Model\Entity\Developer> $developers
 */
?>
<div class="developers index content">
    <?= $this->Html->link(__('New Developer'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Developers') ?></h3>
