 ...
 * @property \App\Model\Table\DevelopersTable&\Cake\ORM\Association\BelongsToMany $Developers
 *
...
class ProjectsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('git_repo')
            ->maxLength('git_repo', 255)
            ->allowEmptyString('git_repo');
